...
const AdminEditProduct = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/admin/products/${id}`, {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      await axios.put(`${process.env.REACT_APP_API_URL}/api/admin/products/${id}`, formData, {
        headers: {
